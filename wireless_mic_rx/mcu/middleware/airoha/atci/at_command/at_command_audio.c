...
//                SltTaskSuspendReq();
            ...
            /* SMT item for airoha automotive product */
                ...
                audio_volume_monitor_start(audio_scenario_type, &param);
                ...
                audio_volume_monitor_stop(audio_scenario_type);
                ...
                uint32_t addr = 0;
                uint32_t data_len = 1;
                audio_volume_monitor_get_data(audio_scenario_type, &addr, &data_len);
                if(addr != 0){
