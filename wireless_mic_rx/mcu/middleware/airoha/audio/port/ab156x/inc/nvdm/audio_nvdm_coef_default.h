...
const dsp_feature_t g_dsp_feature_table[DSP_FEATURE_MAX_NUM] = {
    ...
    {FUNC_TX_NR_v2,           {NVKEY_DSP_PARA_A2DP_AU_CPD, NVKEY_DSP_PARA_POSITIVE_GAIN, NVKEY_DSP_PARA_WB_TX_VO_CPD, ECNR_WB_NVKEY_LIST, NVKEY_END} },/*0x6D FUNC_TX_NR_v2,       */
...
#if defined (AIR_SILENCE_DETECTION_ENABLE) || (AIR_AUDIO_VOLUME_MONITOR_ENABLE)
