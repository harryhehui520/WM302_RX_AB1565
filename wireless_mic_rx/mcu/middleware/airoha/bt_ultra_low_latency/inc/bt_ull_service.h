...
#define BT_ULL_EVENT_LE_GET_RSSI_1                            0x50     /**< HWJ: Get device 1 rssi. */
#define BT_ULL_EVENT_LE_GET_RSSI_2                            0x51     /**< HWJ: Get device 2 rssi. */

#define BT_ULL_EVENT_SETTING_UPDATE                           0x52

#define BT_ULL_EVENT_PRINT_RTC_TIME                           0x53

#define BT_ULL_EVENT_USER_PAIRING_END_TIMEOUT                 0x54
...
#define BT_ULL_ACTION_CHANGE_REMOTE_SIRK                      0x16     /**< Change the sirk of the client, for parameter please refer to structure #bt_ull_change_remote_sirk_t*/
...
/**
* @brief This structure defined the parameters of #BT_ULL_ACTION_CHANGE_REMOTE_SIRK
*                which is used for user to change the sirk of remote device
*/
typedef struct {
    bt_handle_t        handle;               /**< The LE connection handle. */
    bt_key_t           sirk;                 /**< The SIRK information. */
} bt_ull_change_remote_sirk_t;
