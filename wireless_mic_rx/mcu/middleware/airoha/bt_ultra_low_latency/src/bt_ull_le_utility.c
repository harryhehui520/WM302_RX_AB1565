...
/***********************************************************Down Link***********************************************************************************/
static bt_ull_le_codec_param_t g_ull_le_spk_stream_param_samp_48k_br_200k_stero = {
...
static n9_dsp_share_info_t *bt_ull_le_srv_get_avm_buffer_info(bt_ull_le_share_info_t type, uint32_t bit_rate,
...
static void bt_ull_le_srv_reverse_copy(uint8_t *dst, const uint8_t *src, uint32_t length)
{
    uint32_t i;
...
static void bt_ull_le_srv_random(bt_key_t output)
{
    uint8_t i;
...
static void bt_ull_le_srv_encrypt(bt_key_t output, const bt_key_t key, const bt_key_t data)
{
...
static bool bt_ull_le_srv_endian_order_swap(uint8_t *dest, const uint8_t *src, uint8_t len)
{
...
uint32_t bt_ull_le_srv_get_codec_sample_rate(bt_ull_transmitter_t transmitter, bool is_uplink)
{
    bt_ull_le_srv_stream_context_t *stream_ctx = bt_ull_le_srv_get_stream_context();

    if (BT_ULL_ROLE_SERVER == g_ull_le_ctx.role) {
    ...
    } else if (BT_ULL_ROLE_CLIENT == g_ull_le_ctx.role) {
        if (is_uplink) {
...
uint32_t bt_ull_le_srv_get_usb_sample_rate(bt_ull_transmitter_t transmitter)
{
    bt_ull_le_srv_stream_context_t *stream_ctx = bt_ull_le_srv_get_stream_context();
...
uint32_t bt_ull_le_srv_get_usb_sample_size(bt_ull_transmitter_t transmitter)
{
    bt_ull_le_srv_stream_context_t *stream_ctx = bt_ull_le_srv_get_stream_context();
...
uint32_t bt_ull_le_srv_get_usb_sample_channel(bt_ull_transmitter_t transmitter)
{
    bt_ull_le_srv_stream_context_t *stream_ctx = bt_ull_le_srv_get_stream_context();
...
uint32_t bt_ull_le_srv_get_bitrate(bool is_uplink)
{
    bt_ull_le_srv_stream_context_t *stream_ctx = bt_ull_le_srv_get_stream_context();
...
uint32_t bt_ull_le_srv_get_sdu_interval(bool is_uplink)
{
...
uint16_t bt_ull_le_srv_get_sdu_size(bool is_uplink)
{
    bt_ull_le_srv_stream_context_t *stream_ctx = bt_ull_le_srv_get_stream_context();
...
bt_ull_le_channel_mode_t bt_ull_le_srv_get_channel_mode(bt_ull_transmitter_t transmitter, bool is_uplink)
{
    bt_ull_le_srv_stream_context_t *stream_ctx = bt_ull_le_srv_get_stream_context();
...
void bt_ull_le_srv_switch_codec_params(uint8_t index)
{
    ...
    switch (index) {       
#ifndef AIR_WIRELESS_MIC_ENABLE
        case 0: {
            bt_ull_le_srv_set_codec_param(g_ull_le_ctx.role, &(g_ull_le_spk_stream_param_samp_96k_br_172k_stero), ul_codec_param);
        ...
        case 1: {
            /**< Default Codec Parameters. */
            bt_ull_le_srv_set_codec_param(g_ull_le_ctx.role, &(g_ull_le_spk_stream_param_samp_96k_br_304k_stero), ul_codec_param);
            ull_report("[ULL][LE] DL codec: 96Khz/304Kbps!", 0);
        }
        break;
#endif
        case 2: {    
            bt_ull_le_srv_set_codec_param(g_ull_le_ctx.role, &(g_ull_le_spk_stream_param_samp_48k_br_200k_stero), ul_codec_param);
...
static n9_dsp_share_info_t *bt_ull_le_srv_get_avm_buffer_info(bt_ull_le_share_info_t type, uint32_t bit_rate, uint32_t frame_interval, uint32_t frame_size)
{
        ...
        for (i = 0; i < BT_ULL_LE_SHARE_INFO_MAX_NUM; i ++) {
            if ((i == BT_ULL_LE_SHARE_INFO_DL_CH_1) || (i == BT_ULL_LE_SHARE_INFO_DL_CH_2)) {
                ...
                g_ull_le_share_info[i] = bt_ull_le_srv_get_avm_buffer_info(i,
                                                                  bt_ull_le_srv_get_bitrate(false),
                                                                  bt_ull_le_srv_get_sdu_interval(false),
                                                                  bt_ull_le_srv_get_sdu_size(false));
            } else {
                /*slim code , Uplink buffer*/
                g_ull_le_share_info[i] = bt_ull_le_srv_get_avm_buffer_info(i,
                                                                  bt_ull_le_srv_get_bitrate(true),
                                                                  bt_ull_le_srv_get_sdu_interval(true),
                                                                  bt_ull_le_srv_get_sdu_size(true));
            }
        }
        for (i = 0; i < BT_ULL_LE_TRANSMITTER_SHARE_INFO_MAX; i ++) {
...
bt_status_t bt_ull_le_srv_set_avm_share_buffer(bt_ull_client_t client_type)
{
    bt_ull_le_conn_srv_avm_buffer_info_t *share_buffer;
    uint8_t i, cis_count;
    bt_status_t status;
    if (BT_ULL_ROLE_SERVER == g_ull_le_ctx.role) {
    cis_count = g_ull_le_ctx.cis_num;
    } else {
        cis_count = 0x02;
    }
    ...
    if (BT_ULL_HEADSET_CLIENT == client_type \
        ...
        uint32_t dl_bitrate = bt_ull_le_srv_get_bitrate(false);
        uint32_t ul_bitrate = bt_ull_le_srv_get_bitrate(true);
        uint32_t sdu_interval = bt_ull_le_srv_get_sdu_interval(false);
    ...
    status = bt_ull_le_conn_srv_set_avm_share_buffer(share_buffer);
...
void bt_ull_le_srv_set_opus_codec_param(void)
{
    ...
    #ifdef AIR_BTA_IC_PREMIUM_G2
    bt_ull_le_srv_set_codec_param(g_ull_le_ctx.role, &(g_ull_le_spk_stream_param_samp_48k_br_320k_stero), &(g_ull_le_mic_stream_param_samp_16k_br_64k_mono));
...
bt_ull_le_codec_t bt_ull_le_srv_get_client_preffered_codec(void)
{
...
uint32_t bt_ull_le_srv_get_client_preffered_dl_codec_samplerate(void)
{
    uint32_t samplerate = BT_ULL_LE_DEFAULT_SAMPLERTE_96K; //default dl 96K
    #ifdef AIR_DCHS_MODE_ENABLE
        samplerate = g_ull_le_dchs_dl_codec_samplerate;
        ull_report("[ULL][LE] DCHS support DL saplerate: %d!", 1, samplerate);
        ...
        ull_report("[ULL][LE] Dual Chip support DL saplerate: %d!", 1, samplerate);
    #elif defined(AIR_AUDIO_VEND_CODEC_ENABLE)
        samplerate = BT_ULL_LE_DEFAULT_SAMPLERTE_48k;
        ull_report("[ULL][LE] Opus Codec support DL saplerate: %d!", 1, samplerate);
    #elif defined (AIR_AUDIO_ULD_CODEC_ENABLE)
        samplerate = BT_ULL_LE_DEFAULT_SAMPLERTE_48k; 
        ull_report("[ULL][LE] ULD Codec support DL saplerate: %d!", 1, samplerate);
    #elif (AIR_AUDIO_LC3PLUS_CODEC_ENABLE)
        samplerate = BT_ULL_LE_DEFAULT_SAMPLERTE_96K;
        ull_report("[ULL][LE] LC3+ Codec support DL saplerate: %d!", 1, samplerate);
...
uint32_t bt_ull_le_srv_get_client_preffered_ul_codec_samplerate(void)
{
