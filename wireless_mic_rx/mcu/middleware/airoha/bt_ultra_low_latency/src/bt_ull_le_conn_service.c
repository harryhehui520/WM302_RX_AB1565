...
#define BT_ULL_LE_CONN_SRV_ISO_INTERVAL_1P25MS         (0x01)
#define BT_ULL_LE_CONN_SRV_ISO_INTERVAL_2P5MS          (0x02)
#define BT_ULL_LE_CONN_SRV_ISO_INTERVAL_5MS            (0x04)
#define BT_ULL_LE_CONN_SRV_ISO_INTERVAL_7P5MS          (0x06)
#define BT_ULL_LE_CONN_SRV_ISO_INTERVAL_10MS           (0x08)
#define BT_ULL_LE_CONN_SRV_ISO_INTERVAL_15MS           (0x0C)
#define BT_ULL_LE_CONN_SRV_ISO_INTERVAL_20MS           (0x10)
typedef uint16_t bt_ull_le_conn_srv_iso_interval_t; /* unit is 1.25 ms*/
...
#define BT_ULL_LE_CONN_SRV_DATA_PATH_ID_HCI            (0x00)
#define BT_ULL_LE_CONN_SRV_DATA_PATH_ID_1              (0x01)
#define BT_ULL_LE_CONN_SRV_DATA_PATH_ID_2              (0x02)
// for wireless mic
#define BT_ULL_LE_CONN_SRV_DATA_PATH_ID_3              (0x03)
#define BT_ULL_LE_CONN_SRV_DATA_PATH_ID_4              (0x04)
#define BT_ULL_LE_CONN_SRV_DATA_PATH_ID_SPK_SPECIAL    (0x30)
#define BT_ULL_LE_CONN_SRV_DATA_PATH_ID_DISABLE        (0xFF)
typedef uint8_t bt_ull_le_conn_srv_iso_data_path_t;
...
typedef struct {
    ...
    bt_ull_le_conn_srv_air_cis_id_enum cis_id;
...
typedef struct {
    ...
    bt_ull_le_conn_srv_iso_data_path_t data_path_id;
    bt_ull_le_conn_srv_air_cis_id_enum cis_id;
...
typedef struct {
    ...
    uint8_t                                max_ul_num;
    bt_ull_le_conn_srv_iso_interval_t      iso_interval;
    uint32_t                               dl_bitrate;
    uint32_t                               ul_bitrate;
...
static bt_ull_le_conn_srv_air_cig_param_t g_cig_param_table_opus[] = {
    {
        ...
        BT_ULL_LE_CONN_SRV_PHY_LE_2M,
        BT_ULL_LE_CONN_SRV_PHY_LE_2M,
        0x2,
        0x1,
        BT_ULL_LE_CONN_SRV_ISO_INTERVAL_5MS,
...
static bt_ull_le_conn_srv_air_cig_param_t g_cig_param_table_uld_wireless_mic[] = {
    {
        ...
        0x2,
        0x1,
        BT_ULL_LE_CONN_SRV_ISO_INTERVAL_15MS,
        0x0,
...
/*
static bt_ull_le_conn_srv_air_cig_param_t g_cig_param_table_lc3plus_default[] = {
    {
        BT_ULL_LE_SRV_AUDIO_QUALITY_TYPE_DEFAULT,
        BT_ULL_LE_CODEC_LC3PLUS,
        BT_ULL_LE_CONN_SRV_PHY_LE_2M,
...
static const bt_ull_le_conn_srv_cis_id_type_t g_bt_ull_cis_id_table[] = {
    {BT_ULL_LE_AUDIO_LOCATION_FRONT_LEFT, BT_ULL_LE_CONN_SRV_DATA_PATH_ID_1, BT_ULL_LE_CONN_SRV_AIR_CIS_ID_SINK1},
    {BT_ULL_LE_AUDIO_LOCATION_FRONT_RIGHT, BT_ULL_LE_CONN_SRV_DATA_PATH_ID_2, BT_ULL_LE_CONN_SRV_AIR_CIS_ID_SINK2}
};

static const bt_ull_le_conn_srv_cis_id_type_t g_bt_ull_mic_cis_id_table[] = {
    {BT_ULL_LE_AUDIO_LOCATION_NONE, BT_ULL_LE_CONN_SRV_DATA_PATH_ID_1, BT_ULL_LE_CONN_SRV_AIR_CIS_ID_SINK1},
    {BT_ULL_LE_AUDIO_LOCATION_NONE, BT_ULL_LE_CONN_SRV_DATA_PATH_ID_2, BT_ULL_LE_CONN_SRV_AIR_CIS_ID_SINK2},
    {BT_ULL_LE_AUDIO_LOCATION_NONE, BT_ULL_LE_CONN_SRV_DATA_PATH_ID_3, BT_ULL_LE_CONN_SRV_AIR_CIS_ID_SINK3},
    {BT_ULL_LE_AUDIO_LOCATION_NONE, BT_ULL_LE_CONN_SRV_DATA_PATH_ID_4, BT_ULL_LE_CONN_SRV_AIR_CIS_ID_SINK4}
};

static const bt_ull_le_conn_srv_cis_id_type_t g_bt_ull_spk_cis_id_table[] = {
    {BT_ULL_LE_AUDIO_LOCATION_NONE, BT_ULL_LE_CONN_SRV_DATA_PATH_ID_SPK_SPECIAL, BT_ULL_LE_CONN_SRV_AIR_CIS_ID_SINK1},
    {BT_ULL_LE_AUDIO_LOCATION_NONE, BT_ULL_LE_CONN_SRV_DATA_PATH_ID_SPK_SPECIAL, BT_ULL_LE_CONN_SRV_AIR_CIS_ID_SINK2},
};
...
static void bt_ull_le_conn_srv_change_air_cig_params_cnf_handler(bt_status_t status, void *cnf);
...
static void bt_ull_le_conn_srv_set_cis_id(uint8_t idx, bt_ull_le_conn_srv_air_cis_id_enum cis_id);
...
static uint8_t bt_ull_le_conn_srv_get_data_path_id(bt_ull_le_conn_srv_air_cis_id_enum cis_id, bt_ull_client_t ct);
...
static bt_status_t bt_ull_le_conn_srv_event_callback(bt_msg_type_t msg, bt_status_t ret, void *buff)
{
...
#ifdef BT_ULL_LE_CONN_SRV_CMD_DEBUG
            ull_report("[ULL][LE][CONN][VENDOR EVT] air cig params change evt, status: 0x%x, cig_id: 0x%x, latency: 0x%x", 3, \
                       ret,
                       params_changed->cig_id,
                       params_changed->params_index
                      );
#endif
...
#endif
            bt_ull_le_conn_srv_change_air_cig_params_cnf_handler(ret, buff);
            break;
        }
    ...
    case BT_ULL_LE_SET_AIR_CIG_PARAMS_TABLE_CNF: {
            bt_hci_le_set_air_cig_table_cnf_t *set_table = (bt_hci_le_set_air_cig_table_cnf_t*)buff;
...
static void bt_ull_le_conn_srv_air_cis_established_handler(bt_status_t status, bt_ull_le_air_cis_established_ind_t *ind)
{
    ...
    if (status != BT_STATUS_SUCCESS || ind->status != BT_STATUS_SUCCESS) {
        ...
        if (BT_HCI_STATUS_CONNECTION_FAILED_TO_BE_ESTABLISHED == status && BT_ULL_HEADSET_CLIENT != ct && role == BT_ULL_ROLE_SERVER) {
...
static void bt_ull_le_conn_srv_air_cig_params_changed_handler(bt_status_t status, bt_ull_le_air_cig_params_changed_ind_t *ind)
{
    ull_report("[ULL][LE][CONN] AIR CIG LABEL CHANGED, status: %x!, cig_idx: %d, latency_idx: %d", 3, \
        status, ind->params_index, ind->ft_label_index);
    if (status != BT_STATUS_SUCCESS) {
    ...
    if (ind->params_index >= ctx->aud_ctrl.label_count || ind->ft_label_index >= BT_ULL_LE_FT_LABEL_MAX) {
        assert(0);
        return;
    }
    bt_ull_le_conn_srv_air_cis_evt_ind_t evt;
    ...
    evt.label_changed.audio_quility = ctx->aud_ctrl.select_cig_params[ind->params_index].audio_quality;
...
static void bt_ull_le_conn_srv_change_air_cig_params_cnf_handler(bt_status_t status, void *cnf)
{
    ...
    if (status != BT_STATUS_SUCCESS) {
        ull_report_error("[ULL][LE][CONN] bt_ull_le_conn_srv_change_air_cig_params_cnf_handler, status error: %x!", 1, status);
...
static void bt_ull_le_conn_srv_set_air_params_table_cnf_handler(bt_status_t status, void *cnf)
{
    ...
    bt_hci_le_set_air_cig_table_cnf_t *air_set_ind = (bt_hci_le_set_air_cig_table_cnf_t *)cnf;
...
static bt_status_t bt_ull_le_conn_srv_setup_air_iso_data_path_internal(bt_handle_t cis_handle)
{
    ...
    if (BT_ULL_ROLE_CLIENT == role) {
        if ((BT_ULL_HEADSET_CLIENT == ct && idx != 0x0) \
            ...
            bt_ull_le_srv_set_avm_share_buffer(ct);
        }
    }
    ...
    if (BT_ULL_LE_CONN_SRV_DATA_PATH_ID_DISABLE == data_path_id) {
...
bt_status_t bt_ull_le_conn_srv_set_air_cig_params(uint8_t cis_count)
{
    ...
    uint32_t m2s_sdu_interval = bt_ull_le_srv_get_sdu_interval(false);
    uint32_t s2m_sdu_interval = bt_ull_le_srv_get_sdu_interval(true);
    switch (ct)
    {
...
static uint8_t bt_ull_le_conn_srv_get_data_path_id(bt_ull_le_conn_srv_air_cis_id_enum cis_id, bt_ull_client_t ct)
{
    ...
    return BT_ULL_LE_CONN_SRV_DATA_PATH_ID_DISABLE;
...
bt_status_t bt_ull_le_conn_srv_set_avm_share_buffer(bt_ull_le_conn_srv_avm_buffer_info_t *buffer_info)
{
    return bt_avm_set_leaudio_buffer(buffer_info);
}
...
#ifdef BT_ULL_LE_CONN_SRV_DEBUG
    ull_report("[ULL][LE][CONN] bt_ull_le_conn_srv_set_air_cig_params_table, handle: 0x%x, ct: 0x%x, cis: %d, capability: %x, table: %x, codec: %d, ul samp: %d, dl samp: %d", 8, \
        acl_handle, ct, cis_count, *capability, ctx->aud_ctrl.select_cig_params, codec, ul_samplerate, dl_samplerate);
#endif
