...
{//TODO
    ...
    for(i = 0; i < bt_out_param->link_num; i++) {
        ...
        bt_out_param->link_param[i].codec_type = (BT_ULL_LE_CODEC_LC3PLUS == codec_type) ? AUDIO_DSP_CODEC_TYPE_LC3PLUS : AUDIO_DSP_CODEC_TYPE_OPUS;//default lc3plus codec
        bt_out_param->link_param[i].codec_param.lc3plus.sample_rate = bt_ull_le_srv_get_codec_sample_rate(transmitter_type, false);//96000
        bt_out_param->link_param[i].codec_param.lc3plus.sample_format = (BT_ULL_LE_CODEC_LC3PLUS == codec_type) ? HAL_AUDIO_PCM_FORMAT_S24_LE : HAL_AUDIO_PCM_FORMAT_S16_LE;//default lc3plus codec
        uint32_t bit_rate = bt_ull_le_srv_get_bitrate(false);
        bt_out_param->link_param[i].codec_param.lc3plus.bit_rate = bit_rate/2;
        /*switch channel mode*/
        bt_ull_le_channel_mode_t channel_mode = bt_ull_le_srv_get_channel_mode(transmitter_type, false);
        bt_out_param->link_param[i].codec_param.lc3plus.channel_mode = bt_ull_le_at_switch_channel_mode(channel_mode);
        bt_out_param->link_param[i].codec_param.lc3plus.frame_interval = bt_ull_le_srv_get_sdu_interval(false);//5000
        uint32_t frame_size = bt_ull_le_srv_get_sdu_size(false);//108
        bt_out_param->link_param[i].codec_param.lc3plus.frame_size = frame_size/2;//54
    }
}
...
{//TODO
    ...
    for (i = 0; i < bt_in_param->link_num; i++) {
        ...
        bt_in_param->link_param[i].codec_type = (BT_ULL_LE_CODEC_LC3PLUS == codec_type) ? AUDIO_DSP_CODEC_TYPE_LC3PLUS : AUDIO_DSP_CODEC_TYPE_OPUS;//default lc3plus codec
        bt_in_param->link_param[i].codec_param.lc3plus.sample_rate = bt_ull_le_srv_get_codec_sample_rate(transmitter_type, true);//32000;
        if (BT_ULL_MIC_TRANSMITTER == transmitter_type) {
            bt_in_param->link_param[i].codec_param.lc3plus.sample_format = bt_ull_le_at_switch_sample_size(bt_ull_le_srv_get_usb_sample_size(transmitter_type));
        } else {
        ...
        bt_in_param->link_param[i].codec_param.lc3plus.bit_rate = bt_ull_le_srv_get_bitrate(true);//32*1000;
        bt_in_param->link_param[i].codec_param.lc3plus.channel_mode = bt_ull_le_srv_get_channel_mode(transmitter_type, true);//0x8;
        bt_in_param->link_param[i].codec_param.lc3plus.frame_interval = bt_ull_le_srv_get_sdu_interval(true);//5000;
        bt_in_param->link_param[i].codec_param.lc3plus.frame_size = bt_ull_le_srv_get_sdu_size(true);///40;
    }
}
static void bt_ull_le_at_gaming_callback(audio_transmitter_event_t event, void *data, void *user_data)
{
...
static void bt_ull_le_at_handle_spk_stop_success_or_start_fail_cnf(bt_ull_transmitter_t transmitter_type)
{
    ...
    if (p_stream_info->streaming_flag & BT_ULL_LE_STREAMING_NEED_DEINIT) {
        ...
        if ((BT_ULL_LE_AT_SILENCE_DETECTION_MODE_SPECIAL == silence_detection_mode) && (p_stream_info->streaming_flag & BT_ULL_LE_STREAMING_WAIT_STOP_NORMAL_MODE)) {
            ...
            if (p_stream_info->is_request_transmitter_start && bt_ull_le_srv_is_connected()) {
            ...
            if (p_stream_info_other->streaming_flag & BT_ULL_LE_STREAMING_START_BLOCKED) {
                ...
                if (p_stream_info_other->is_request_transmitter_start && bt_ull_le_srv_is_connected()) {
        ...
        } else if (!bt_ull_le_srv_is_connected() && (BT_ULL_LE_AT_SILENCE_DETECTION_MODE_SPECIAL == silence_detection_mode)) {
            bt_ull_le_at_set_silence_detection_mode(BT_ULL_LE_AT_SILENCE_DETECTION_MODE_NORMAL);
...
static void bt_ull_le_at_config_spk_transmitter_param(bt_ull_transmitter_t transmitter_type, bt_ull_client_t client_type, uint8_t out_type, audio_transmitter_config_t* config)
{
    ...
    usb_in_param->codec_param.pcm.sample_rate = bt_ull_le_srv_get_usb_sample_rate(transmitter_type);
    usb_in_param->codec_param.pcm.format = bt_ull_le_at_switch_sample_size(bt_ull_le_srv_get_usb_sample_size(transmitter_type));
    usb_in_param->codec_param.pcm.channel_mode = bt_ull_le_srv_get_usb_sample_channel(transmitter_type);
...
static void bt_ull_le_at_config_linein_transmitter_param(bt_ull_transmitter_t transmitter_type, bt_ull_client_t client_type, uint8_t out_type, audio_transmitter_config_t* config)
{
    ...
    line_in_param->codec_param.pcm.sample_rate = bt_ull_le_srv_get_usb_sample_rate(transmitter_type);
...
static void bt_ull_le_at_wireless_mic_set_bt_out_param(bt_ull_transmitter_t transmitter_type, bt_ull_client_t client_type, uint8_t out_type, wireless_mic_rx_bt_in_param_t *bt_in_param, uint8_t link_num)
{
    ...
    for (i = 0; i < bt_in_param->link_num; i++) {
        ...
        bt_in_param->link_param[i].codec_param.lc3plus.sample_rate = bt_ull_le_srv_get_codec_sample_rate(transmitter_type, true);
            bt_in_param->link_param[i].codec_param.lc3plus.sample_format = HAL_AUDIO_PCM_FORMAT_S24_LE;
        bt_in_param->link_param[i].codec_param.lc3plus.bit_rate = bt_ull_le_srv_get_bitrate(true);
        bt_in_param->link_param[i].codec_param.lc3plus.channel_mode = bt_ull_le_srv_get_channel_mode(2, true);
        bt_in_param->link_param[i].codec_param.lc3plus.frame_interval =  bt_ull_le_srv_get_sdu_interval(true);
        bt_in_param->link_param[i].codec_param.lc3plus.frame_size = bt_ull_le_srv_get_sdu_size(true);
        } else if (BT_ULL_LE_CODEC_ULD == codec_type) {
            bt_in_param->link_param[i].codec_type = AUDIO_DSP_CODEC_TYPE_ULD;
            bt_in_param->link_param[i].codec_param.uld.sample_rate = bt_ull_le_srv_get_codec_sample_rate(transmitter_type, true);
            bt_in_param->link_param[i].codec_param.uld.sample_format = HAL_AUDIO_PCM_FORMAT_S24_LE;
            bt_in_param->link_param[i].codec_param.uld.bit_rate = bt_ull_le_srv_get_bitrate(true);
            bt_in_param->link_param[i].codec_param.uld.channel_mode = bt_ull_le_srv_get_channel_mode(2, true);
            bt_in_param->link_param[i].codec_param.uld.frame_interval =  bt_ull_le_srv_get_sdu_interval(true);
            bt_in_param->link_param[i].codec_param.uld.frame_size = bt_ull_le_srv_get_sdu_size(true);
        } else {
