...
#define RACE_ID_UART_TRANS_BEGIN  0x2F20
#define RACE_ID_UART_TRANS_END    0x2F2F
extern void *race_cmd_nxp_uart_CmdHandler(ptr_race_pkt_t pCmdMsg, uint16_t length, uint8_t channel_id);
...
const RACE_HANDLER race_handlers[] = {
    ...
    {RACE_ID_UART_TRANS_BEGIN, RACE_ID_UART_TRANS_END, race_cmd_nxp_uart_CmdHandler},
