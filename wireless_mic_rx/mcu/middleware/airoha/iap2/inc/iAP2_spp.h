...
#ifndef __IAP2_SPP_H__
#define __IAP2_SPP_H__
...
#define BT_SPP_IAP2_SERVER_ID  0x1E /**< the iAP2 server ID.*/
...
bt_status_t bt_iap2_send_data(uint32_t handle, uint8_t *packet, uint16_t packet_size);
bt_status_t bt_iap2_connect(uint32_t *handle, const bt_bd_addr_t *address, const uint8_t *uuid128);
