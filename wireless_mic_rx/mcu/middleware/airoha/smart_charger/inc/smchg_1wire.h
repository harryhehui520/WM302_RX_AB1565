...
extern void nxp_uart_init(void);
extern void nxp_uart_pre_handle(void);
extern void nxp_uart_tx_send_notification(const uint8_t *payload, uint16_t size_payload);
