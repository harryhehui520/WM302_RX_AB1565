...
#define HAL_DUMP_PERIPHERAL_REGISTER  \
        ...
        {"cksys_230"       ,   (unsigned int *)(0xA2020230           ),    (unsigned int *)(0xA2020230     + 0x14 ), 1}, \
        {"cksys_280"       ,   (unsigned int *)(0xA2020280           ),    (unsigned int *)(0xA2020280     + 0xC  ), 1}, \
        {"cksys_304"       ,   (unsigned int *)(0xA2020304           ),    (unsigned int *)(0xA2020304     + 0x4  ), 1}, \
        {"cksys_xo_clk_B00",   (unsigned int *)(0xA2030B00           ),    (unsigned int *)(0xA2030B00     + 0x4  ), 1}, \
        {"cksys_xo_clk_B30",   (unsigned int *)(0xA2030B30           ),    (unsigned int *)(0xA2030B30     + 0x4  ), 1}, \
        {"cksys_xo_clk_B60",   (unsigned int *)(0xA2030B60           ),    (unsigned int *)(0xA2030B60     + 0x4  ), 1}, \
        {"mixedsys_d_100"  ,   (unsigned int *)(0xA2040100           ),    (unsigned int *)(0xA2040100     + 0x4  ), 1}, \
        {"mixedsys_d_200"  ,   (unsigned int *)(0xA2040200           ),    (unsigned int *)(0xA2040200     + 0x4  ), 1}, \
        {"xpll_ctrl_004"   ,   (unsigned int *)(0xA2050004           ),    (unsigned int *)(0xA2050004     + 0x4  ), 1}, \
        {"xpll_ctrl_104"   ,   (unsigned int *)(0xA2050104           ),    (unsigned int *)(0xA2050104     + 0x4  ), 1}, \
        {"dcxo_pwr_ctrl_014",  (unsigned int *)(0xA2060014           ),    (unsigned int *)(0xA2060014     + 0x8  ), 1}, \
        {"cksys_bus_clk_300",  (unsigned int *)(0xA21E0300           ),    (unsigned int *)(0xA21E0300     + 0x4  ), 1}, \
        {"dcxo_cfg_008"    ,   (unsigned int *)(0xA30D0008           ),    (unsigned int *)(0xA30D0008     + 0x14 ), 1}, \
