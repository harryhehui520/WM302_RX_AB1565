...
#define SHARE_BUFFER_ADVANCED_RECORD_SIZE  (3*(16UL*1024+4))
#else
#define SHARE_BUFFER_ADVANCED_RECORD_SIZE  (30*1024)
#endif

#ifdef AIR_RECORD_ADVANCED_ENABLE
#define SHARE_BUFFER_BT_AUDIO_DL_SIZE      (10UL*1024+ SHARE_BUFFER_ADVANCED_RECORD_SIZE)
#else
...
#ifdef AIR_RECORD_ADVANCED_ENABLE
#define SHARE_BUFFER_RECORD_SIZE           (4)
#else
...
#ifdef AIR_RECORD_ADVANCED_ENABLE
#define SHARE_BUFFER_BT_AUDIO_USB_IN_1_SIZE   (4)
#else
#define SHARE_BUFFER_BT_AUDIO_USB_IN_1_SIZE   (4640) /* Support 96K/24bit/2ch/8ms(5ms+3ms) */
#endif
...
//#ifdef AIR_USB_AUDIO_2ND_SPEAKER_ENABLE
    uint32_t usb_in_1[(SHARE_BUFFER_BT_AUDIO_USB_IN_1_SIZE + 3) / 4];
//#endif
