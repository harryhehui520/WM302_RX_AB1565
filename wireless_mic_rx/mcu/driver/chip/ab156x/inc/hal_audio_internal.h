...
/*############################################AMIC config part####################################*/
typedef struct HAL_DSP_PARA_AU_AFE_AMIC_CONFIG_s {
        /*
            0x0: ACC_10k,
            0x1: ACC_20k,
            0x2: DCC,
        */
        uint8_t ADDA_Analog_MIC_Mode;

        /*  0x0: MEMS,
            0x1: ECM Differential,
            0x2: ECM Single,
        */
        uint8_t ADDA_Analog_MIC_VIN_PUD;
}PACKED HAL_DSP_PARA_AU_AFE_AMIC_CONFIG_t;
...
typedef struct HAL_DSP_PARA_AU_AFE_ADC_DAC_CONFIG_s {
    ...
    */
    ...
    HAL_DSP_PARA_AU_AFE_AMIC_CONFIG_t amic_config[6];
