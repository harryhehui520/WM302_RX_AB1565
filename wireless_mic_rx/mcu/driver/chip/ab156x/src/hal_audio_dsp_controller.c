...
void hal_audio_dsp_controller_init(void)
{
    ...
    hal_audio_init_share_info_section(&audio_transmitter_share_info[AUDIO_TRANSMITTER_SHARE_INFO_INDEX_GAMING_MODE_DSP_SEND_TO_MCU],&audio_share_buffer.bt_audio_dl[0]+(SHARE_BUFFER_ADVANCED_RECORD_SIZE)/4,10*1024);
    ...
    hal_audio_init_share_info_section(&audio_transmitter_share_info[AUDIO_TRANSMITTER_SHARE_INFO_INDEX_ADVANCED_RECORD_N_MIC],      (&audio_share_buffer.bt_audio_dl[0]), SHARE_BUFFER_ADVANCED_RECORD_SIZE);
