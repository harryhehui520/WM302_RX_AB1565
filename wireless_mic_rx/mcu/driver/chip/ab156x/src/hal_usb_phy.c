...
void hal_usbphy_poweron_initialize(void)
{
    ...
    hal_gpt_delay_ms(1);
    DRV_WriteReg32((USB_PHY_MSTAR+0x868), 0x1420A720);    //U2PLL enable
    DRV_WriteReg32((USB_PHY_MSTAR+0x808), 0x80400084);    //utmi
    ...
    hal_clock_enable(HAL_CLOCK_CG_USB);
    hal_gpt_delay_ms(1);
    DRV_WriteReg32((USB_PHY_MSTAR+0x808), 0x80400004);    //utmi
    ...
    while((DRV_Reg32(USB_PHY_MSTAR+0x838) & 0x2) != 0);
