...
#define chg_curr_offset_thrd          600
...
uint8_t pmu_kflag;
uint16_t vbat_sel = 0;
uint16_t offset_4v35 = 0;
uint16_t offset_4v2 = 0;
...
void pmu_set_ldo_vrf_ret(void)
{
    ...
    pmu_set_register_value_lp(LV3_STB_REGSEL_ADDR, LV3_STB_REGSEL_MASK, LV3_STB_REGSEL_SHIFT, 0);
}
...
{
    uint16_t rsel_4v35 = 0, rsel_4v2 = 0, target_curr = 0, target_curr_4v35 = 0, target_curr_4v2 = 0;
    ...
    for (uint8_t i = 0; i < nvkey.cal_cnt; i++) {
        target_curr = nvkey.data[i].curr;
        target_curr_4v35 = target_curr;
        target_curr_4v2 = target_curr;
        if (target_curr <= chg_curr_offset_thrd) {
            target_curr_4v35 = target_curr + offset_4v35;
            target_curr_4v2 = target_curr + offset_4v2;
        }
        rsel_4v35 = pmu_lerp(otp_curr.bat_4v35[0].curr, otp_curr.bat_4v35[0].val, otp_curr.bat_4v35[1].curr, otp_curr.bat_4v35[1].val, target_curr_4v35);
        rsel_4v2 = pmu_lerp(otp_curr.bat_4v2[0].curr, otp_curr.bat_4v2[0].val, otp_curr.bat_4v2[1].curr, otp_curr.bat_4v2[1].val, target_curr_4v2);
...
void pmu_cal_chg_curr_otp(void)
{
    ...
    offset_4v35 = pmu_round(((-otp_4v35.data[0].val) * (otp_4v35.data[1].curr - otp_4v35.data[0].curr)), (otp_4v35.data[1].val - otp_4v35.data[0].val)) + otp_4v35.data[0].curr - 10;
    offset_4v2 = pmu_round(((-otp_4v2.data[0].val) * (otp_4v2.data[1].curr - otp_4v2.data[0].curr)), (otp_4v2.data[1].val - otp_4v2.data[0].val)) + otp_4v2.data[0].curr - 10;
}
...
void pmu_cal_chg_jeita_cfg(uint16_t nvkey_id)
{
    ...
    uint16_t target_curr = 0, target_curr_4v35 = 0, target_curr_4v2 = 0;
    ...
    cc1_rsel_4v2  = pmu_lerp(otp_curr.bat_4v2[0].curr, otp_curr.bat_4v2[0].val, otp_curr.bat_4v2[1].curr, otp_curr.bat_4v2[1].val, target_curr_4v2);
    cc1_rsel_4v35 = pmu_lerp(otp_curr.bat_4v35[0].curr, otp_curr.bat_4v35[0].val, otp_curr.bat_4v35[1].curr, otp_curr.bat_4v35[1].val, target_curr_4v35);
    ...
    cc2_rsel_4v2  = pmu_lerp(otp_curr.bat_4v2[0].curr, otp_curr.bat_4v2[0].val, otp_curr.bat_4v2[1].curr, otp_curr.bat_4v2[1].val, target_curr_4v2);
    cc2_rsel_4v35 = pmu_lerp(otp_curr.bat_4v35[0].curr, otp_curr.bat_4v35[0].val, otp_curr.bat_4v35[1].curr, otp_curr.bat_4v35[1].val, target_curr_4v35);
