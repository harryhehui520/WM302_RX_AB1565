...
ifeq ($(AIR_DONGLE_AFE_IN_TYPE), LINE_IN)
COM_CFLAGS += -DAIR_BT_AUDIO_DONGLE_LINE_IN_ENABLE
endif

ifeq ($(AIR_DONGLE_AFE_IN_TYPE), I2S_MST_IN)
COM_CFLAGS += -DAIR_BT_AUDIO_DONGLE_I2S_IN_ENABLE
endif

ifeq ($(AIR_DONGLE_AFE_IN_TYPE), I2S_SLV_IN)
COM_CFLAGS += -DAIR_BT_AUDIO_DONGLE_I2S_IN_ENABLE
COM_CFLAGS += -DAIR_BT_AUDIO_DONGLE_I2S_IN_TRACKING_VDMA_MODE_ENABLE
endif
...
CFLAGS += -DAIR_SYSTEM_CLOCK_208M
else ifeq ($(AIR_DVFS_MIN_LEVEL), DVFS_NV)
CFLAGS += -DAIR_SYSTEM_CLOCK_104M
else
# DVFS_LV
CFLAGS += -DAIR_SYSTEM_CLOCK_52M
endif
...
CFLAGS += -DAIR_MAX_SYSTEM_CLOCK_208M
else ifeq ($(AIR_DVFS_MAX_LEVEL), DVFS_NV)
CFLAGS += -DAIR_MAX_SYSTEM_CLOCK_104M
else
# DVFS_LV
CFLAGS += -DAIR_MAX_SYSTEM_CLOCK_52M
endif
