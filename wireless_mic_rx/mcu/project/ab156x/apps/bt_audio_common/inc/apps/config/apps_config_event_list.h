...
typedef enum {
    ...
    KEY_DONGLE_COMMON_PAIRING_FROM_POWER_ON = 0x00AB, /**< LE ULL + LEA + BT dongle start pairing. */
    ...
    KEY_DONGLE_SWITCH_LEFT_RIGHT = 0x01A5,              /* On dongle side to switch left right channel in merge mode. */
