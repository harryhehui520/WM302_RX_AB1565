...
uint8_t pt_pre_key_id;
uint8_t pt_pre_key_event;           // airo_key_event_t
uint8_t pt_pre_temp_mmi_state;      // apps_config_state_t
uint16_t pt_pre_action_id;          // apps_config_key_action_t
...
#ifdef ARC_PRODUCTION_TEST
#else /* !ARC_PRODUCTION_TEST */
                    pt_pre_key_id = key_id;
                    pt_pre_key_event = key_event;
                    pt_pre_temp_mmi_state = temp_mmi_state;
                    pt_pre_action_id = action_id;
#endif /* ARC_PRODUCTION_TEST */
