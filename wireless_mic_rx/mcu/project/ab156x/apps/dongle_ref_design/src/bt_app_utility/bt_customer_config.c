...
bt_init_feature_mask_t bt_customer_config_get_feature_mask_configuration(void)
{
    ...
    bt_init_feature_mask_t config_feature = /*BT_INIT_FEATURE_MASK_DISABLE_SNIFF_MODE | */BT_INIT_FEATURE_MASK_DISABLE_SNIFF_SUB_MODE | BT_INIT_FEATURE_MASK_BT_5_0 | BT_INIT_FEATURE_MASK_SECURITY_CONNECTION;
