...
#if !defined(AIR_LE_AUDIO_UNICAST_ENABLE) || !defined(AIR_BLE_ULTRA_LOW_LATENCY_ENABLE) || !defined(AIR_BT_SOURCE_ENABLE)
static void app_dongle_le_race_reply_empty_device_list(bool device_list_or_pair_list, uint8_t channel_id)
{
    APPS_LOG_MSGID_I(LOG_TAG"[BT_SRC] reply_empty_device_list %d", 1, device_list_or_pair_list);
...
void app_dongle_le_race_set_current_sink_device(uint8_t sink_device)
{
