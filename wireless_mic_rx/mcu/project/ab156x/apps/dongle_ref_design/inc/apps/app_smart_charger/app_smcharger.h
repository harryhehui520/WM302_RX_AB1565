...
enum {
    ...
    NXP_EVENT_SET_TX1_DEVICE_PARAM,
    NXP_EVENT_SET_TX2_DEVICE_PARAM,
    NXP_EVENT_SET_LR_2_RL_ONOFF,
    NXP_EVENT_SET_SETERO_OR_SAFETY_MODE,
    NXP_EVENT_SET_EQ_MODE,
    NXP_EVENT_SET_RX_GAIN,
    NXP_EVENT_SET_SYSTEM_INFO,

    NXP_EVENT_NXP_LDO_ENABLE,
    NXP_EVENT_INTERRUPT_SIGNAL,
    NXP_EVENT_BATTERY_LEVEL_INIT_CHECK,
#endif /* ARC_NXP_COM_ENABLE */

    SMCHARGER_EVENT_POWERING_ON_TIMEOUT,
    ...
    NXP_EVENT_PT_MODE_TIMEOUT = 0xA0,

    NXP_EVENT_PT_CMD_SET_MODE,
#endif /* ARC_PRODUCTION_TEST */

    NXP_EVENT_FORCE_POWER_DOWN,
};
...
typedef enum {
    APP_SMCHARGER_LID_NONE = 0,
    APP_SMCHARGER_LID_CLOSE,
    APP_SMCHARGER_LID_OPEN
} app_smcharger_lid_close_open_t;
