...
typedef enum {
    TX_DEVICE_INDEX_1 = 0,
    TX_DEVICE_INDEX_2 = 1,
    TX_DEVICE_INDEX_MAX = 2
} tx_device_index_t;

typedef enum {
    RTC_TIME_SETTING_FROM_NONE = 0,
    RTC_TIME_SETTING_FROM_UART = 1,
    RTC_TIME_SETTING_FROM_HID = 2,
    RTC_TIME_SETTING_FROM_AIR = 3,
    RTC_TIME_SETTING_FROM_MAX = 4
} rtc_time_setting_src_t;
...
bool arc_dp_recored_update_display_record_get_tx_device_param(tx_device_index_t index, uint8_t *data, uint8_t data_len);
bool arc_dp_recored_update_display_record_get_rx_device_param(uint8_t *data, uint8_t data_len);
