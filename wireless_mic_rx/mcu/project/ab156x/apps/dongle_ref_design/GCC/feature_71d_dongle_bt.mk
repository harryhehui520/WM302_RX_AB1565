...
IC_CONFIG                             := ab157x
BOARD_CONFIG                          := ab157x_evk
IC_TYPE                               := ab1571d
BOARD_TYPE                            := ab1571d_dongle
BL_FEATURE                            := feature_71_evb_dfu.mk

# Using specific linker script during linking process.
AIR_MCU_LINKER_SCRIPT_FILE = ab1571d_flash.ld
...
# This option is to enable mHDT feature.
AIR_BT_MHDT_ENABLE = n
...
AIR_PRODUCT_CATEGORY = AB1571D_DONGLE
...
# This option controls if pmu uses 1buck or 2buck setting (refer to HW), for AIR_BTA_IC_STEREO_HIGH_G3 only
AIR_PMU_1BUCK_ENABLE = y

# This option is to enable bootloader DFU.
AIR_BL_DFU_ENABLE           = y
##############################################
...
##############################################
include $(SOURCE_DIR)/../dsp/project/$(BOARD)/apps/dsp0_headset_ref_design/XT-XCC/feature_71_evk_leaudio_bt_dongle.mk
