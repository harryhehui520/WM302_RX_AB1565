...
IC_TYPE                               := ab1571d
BOARD_TYPE                            := ab1571d_evk_bt
BL_FEATURE                            := feature_77_evb.mk
...
AIR_PRODUCT_CATEGORY = AB1571D_LEA_DONGLE
...
##############################################
include $(SOURCE_DIR)/../dsp/project/$(BOARD)/apps/dsp0_headset_ref_design/XT-XCC/feature_71_evk_leaudio_bt_dongle_silence_detection.mk
