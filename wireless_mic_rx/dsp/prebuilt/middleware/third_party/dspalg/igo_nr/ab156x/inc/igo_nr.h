...
typedef void (*p_IGO_NR_Init)(void *DRAM_work, uint32_t *nr_para, void *ff_eq_table, uint8_t nr_level, uint8_t band_mode);
typedef void (*p_IGO_NR_Prcs)(int16_t* EC_out1, int16_t* NR_out, uint32_t *nr_para, uint8_t nr_level, void *DRAM_work);
...
extern void igo_txnr_library_load();
extern void igo_txnr_library_unload();
