...
typedef struct {
    ...
    uint32_t sample_rate;
    hal_audio_format_t sample_format;
    hal_audio_device_t audio_device[2];
    hal_audio_interface_t audio_interface[2];
    hal_audio_channel_selection_t channel_select;
} audio_dongle_afe_info_t;
...
typedef union {
    ...
    audio_dongle_afe_info_t afe_in;
...
typedef enum {
    ...
    AUDIO_SCENARIO_TYPE_BT_AUDIO_DONGLE_DL_A2DP_AFE_IN_2 = 90,    /**< Audio scenario type audio transmitter bt source dongle dummy in for music. */
